export default {
  ...
  defaultFmt: [
    ...
    { text: "عدد", value: "##0.00", example: "1000.12" },
    ...
    { text: "", value: "split", example: "" },
    { text: "تاریخ", value: "yyyy-MM-dd", example: "2017-11-29" },
    ...
    { text: "", value: "split", example: "" },
    { text: "Custom formats", value: "fmtOtherSelf", example: "بیشتر" },
  ],
  dateFmtList: [
    {
      name: "1930-08-05",
  ...
  fontarray: ["Times New Roman", "Arial", "Tahoma", "Verdana", "Vazir"],
  fontjson: { "times new roman": 0, arial: 1, tahoma: 2, verdana: 3, Vazir: 4 },
  border: {
    borderTop: "borderTop",
  ...
  screenshot: {
    ...
    rightclickTip: 'Please right-click "کپی" on the picture',
    successTip:
  ...
  findAndReplace: {
    ...
    searchTargetCell: "سلول",
    searchTargetValue: "مقدار",
  ...
  sheetconfig: {
    ...
    unhide: "نمایش دادن",
    moveLeft: "بردن به چپ",
    moveRight: "بردن به راست",
    resetColor: "بازنشانی رنگ",
    cancelText: "لغو",
    chooseText: "تائید رنگ",
  ...
  pivotTable: {
    ...
    valueStatisticsSUM: "جمع",
    valueStatisticsCOUNT: "تعداد",
    valueStatisticsCOUNTA: "Count A",
    valueStatisticsCOUNTUNIQUE: "Count Unique",
    valueStatisticsAVERAGE: "میانگین",
    valueStatisticsMAX: "بیشترین",
    valueStatisticsMIN: "کمترین",
    ...
    titleStasticTrue: "بله",
    titleStasticFalse: "خیر",
  },
  dropCell: {
    copyCell: "کپی",
    sequence: "Sequence",
  ...
  protection: {
    ...
    allowRangeAddTitle: "عنوان",
    allowRangeAddSqrf: "مرجع",
    selectCellRange: "Click to select a cell range",
