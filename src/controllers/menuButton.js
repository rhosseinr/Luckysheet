                ...
                switch (itemvalue) {
                  case "greaterThan":
                    ...
                    content = `<div class="box" data-itemvalue="greaterThan">
                                                ...
                                                <div class="inpbox range form-input">
                                                    <input id="conditionVal" />
                  ...
                  case "betweenness":
                    ...
                    content = `<div class="box" data-itemvalue="betweenness">
                                                ...
                                                <div class="d-flex justify">
                                                    <div class="inpbox2 range form-input">
                                                        <input id="conditionVal" />
                                                        <i class="fa fa-table" aria-hidden="true" title="${conditionformat_text.selectCell}"></i>
                                                    </div>
                                                    <div>To</div>
                                                    <div class="inpbox2 range form-input">
                                                        <input id="conditionVal2" />
                                                        <i class="fa fa-table" aria-hidden="true" title="${conditionformat_text.selectCell}"></i>
                                                    </div>
                                                </div>
                                                <div style="margin: 5px 0;">${conditionformat_text.setAs}：</div>
                  ...
                  case "occurrenceDate":
                    ...
                    content = `<div class="box" data-itemvalue="occurrenceDate">
                                                ...
                                                <div class="inpbox form-input">
                                                    <input id="daterange-btn"  readonly="readonly" placeholder="${conditionformat_text.pleaseSelectADate}"/>
                                                </div>
                                                <div style="margin: 5px 0;">${conditionformat_text.setAs}：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                ...
                switch (itemvalue) {
                  case "top10":
                    ...
                    content = `<div class="box" data-itemvalue="top10">
                                                ...
                                                <div class="d-flex justify">
                                                    <div>${conditionformat_text.top}</div>
                                                    <div class="form-input inpbox2">
                                                        <input id="conditionVal"  type="number" value="10"/>
                                                    </div>
                                                    <div>${conditionformat_text.oneself}</div>
                                                </div>
                                                <div style="margin: 5px 0;">${conditionformat_text.setAs}：</div>
                                                ${textCellColorHtml}
                                            </div>`;
                  ...
                  case "last10":
                    ...
                    content = `<div class="box" data-itemvalue="last10">
                                                ...
                                                <div class="d-flex justify">
                                                    <div>${conditionformat_text.last}</div>
                                                    <div class="form-input inpbox2">
                                                        <input id="conditionVal"  type="number" value="10"/>
                                                    </div>
                                                    <div>${conditionformat_text.oneself}</div>
