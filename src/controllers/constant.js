                        ...
                        <div id ="luckysheet_info_detail" class="luckysheet_info_detail"> 
                            <div data-tips="${
                              locale_info.return
                                ...
                                <i style="color:#d4d4d4;" class="fa fa-angle-left fa-2x" aria-hidden="true"></i> 
                            </div> 
                                                ...
                                                <div class="luckysheet-cell-main " id="luckysheet-cell-main">
                                                    ...
                                                    <div id="luckysheet-image-showBoxs">
                                                        ...
                                                        <div class="cell-date-picker">
                                                            <input id="cellDatePickerBtn" class="form-input formulaInputFocus" readonly="readonly"/>
                                                        </div>
                                                    </div>
...
function luckysheetAlternateformatHtml() {
  ...
  return (
    ...
    "</div>" +
    '<div id="luckysheet-alternateformat-range" class="form-input">' +
...
const luckysheetdefaultFont = function () {
  return (
    ...
    "pt " +
    locale().fontarray[0] +
    ', "system-ui","Helvetica Neue", Helvetica, Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC",  "WenQuanYi Micro Hei", sans-serif'
  );
};
